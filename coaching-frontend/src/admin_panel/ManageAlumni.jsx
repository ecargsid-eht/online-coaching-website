...
const ManageAlumni = () => {
    const {alumni,setAlumni} = useContext(AuthenticationContext)
                    ...
                    <tbody>
                        {
                            alumni.map((alum,i) => (
                                <tr key={i}>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{alum?.id}</td>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{alum?.student.id}</td>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">
                                        <img className='rounded-2' src={alum?.student.user.image || "https://www.pngkey.com/png/detail/121-1219231_user-default-profile.png" } style={{ width: "40px", height: "40px" }} alt="" />
                                    </td>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{alum?.student.user.name}</td>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{alum?.company_name}</td>
                                    <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{alum?.profile}</td>
                                    {/* <td style={{ fontFamily: "Poppins", fontWeight: "300", fontSize: "14px", textAlign: "center" }} className="align-middle">{new Date(alum?.created_at).toLocaleDateString()}</td> */}
